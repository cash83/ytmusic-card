...
`,Pt=V` <svg
    ...
    <path
        ...
        `}async _fireNavigateEvent(t){this.dispatchEvent(new CustomEvent("navigate",{detail:{action:t}}))}async _startRadio(t){this.hass.callService("media_player","shuffle_set",{entity_id:this.entity.entity_id,shuffle:!1}),this.hass.callService("media_player","play_media",{entity_id:this.entity.entity_id,media_content_id:t,media_content_type:"vid_channel"})}async _play(t){"PLAYLIST_GOTO_TRACK"!=t.media_content_type?_t.includes(t.media_class)&&this.hass.callService("media_player","play_media",{entity_id:this.entity.entity_id,media_content_id:t.media_content_id,media_content_type:t.media_content_type}):this.hass.callService("ytube_music_player","call_method",{entity_id:this.entity.entity_id,command:"goto_track",parameters:t.media_content_id})}static get styles(){return[n`
            ...
            `]}};t([pt()],Lt.prototype,"entity",void 0),t([pt()],Lt.prototype,"hass",void 0),t([pt()],Lt.prototype,"element",void 0),t([pt()],Lt.prototype,"current",void 0),Lt=t([lt("ytmusic-list-item")],Lt);let Mt=class extends nt{constructor(){super(...arguments),this._actions=[],this._hasAdditionalActions=!1}firstUpdated(t){this.element.can_expand?this._primaryAction="more":this._primaryAction="play",this._hasAdditionalActions=this.element.can_expand==this.element.can_play?this.element.can_expand:"track"==this.element.media_content_type,this.requestUpdate()}render(){return V`
...
`;class Ht extends nt{constructor(){super(...arguments),this._config={},this._menuOpen=!1}static getConfigElement(){}static getStubConfig(){return{entity_id:"media_player.ytube_music_player"}}setConfig(t){if(!t.entity_id)throw new Error("entity_id must be specified");this._config=structuredClone(t),"header"in this._config||(this._config.header="YouTube Music Search"),this._initialAction=new ht,this._initialAction.title="Home",this._initialAction.media_content_type=null,this._initialAction.media_content_id=null}set hass(t){this._hass=t;const e=this._hass.states[this._config.entity_id];mt(this._entity,e,[])||(this._entity=structuredClone(e))}render(){var t,e,i,s;const o=null===(e=null===(t=this._entity)||void 0===t?void 0:t.attributes)||void 0===e?void 0:e.volume_level,r=null!=o?Math.round(100*o):50,n=null===(s=null===(i=this._entity)||void 0===i?void 0:i.attributes)||void 0===s?void 0:s.is_volume_muted;return V`
            <ha-card>
                <div class="yt-header">
                    <div class="yt-logo">
                        ${Rt}
    ...
    `,t([dt({type:Number})],Ot.prototype,"value",void 0),t([dt({type:Number})],Ot.prototype,"min",void 0),t([dt({type:Number})],Ot.prototype,"max",void 0),t([dt({type:Number})],Ot.prototype,"step",void 0),Ot=t([lt("ytmusic-slider")],Ot);let zt=class extends nt{constructor(){super(...arguments),this._repeatActive=void 0,this._shuffleActive=void 0,this._pct=0}async connectedCallback(){super.connectedCallback(),this._trackProgress()}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.tracker),this.tracker=null}_wavePath(t=800){let e="M0 12 Q10 6 20 12";for(let i=40;i<=t;i+=20)e+=` T${i} 12`;return e}_wave(t){return N`<svg class="wave" width="800" height="24" viewBox="0 0 800 24"
            ...
            <div class="volume">
                ${w?j:V`<button class="radio-btn" @click=${this._startRadio} title="Radio">
                    ${xt}
                </button>`}
                <div class="volwrap">
