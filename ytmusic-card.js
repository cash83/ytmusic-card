...
`,Et=V` <svg
    ...
    <path
        ...
        `}async _fireNavigateEvent(t){this.dispatchEvent(new CustomEvent("navigate",{detail:{action:t}}))}async _startRadio(t){this.hass.callService("media_player","shuffle_set",{entity_id:this.entity.entity_id,shuffle:!1}),this.hass.callService("media_player","play_media",{entity_id:this.entity.entity_id,media_content_id:t,media_content_type:"vid_channel"})}async _play(t){"PLAYLIST_GOTO_TRACK"!=t.media_content_type?(pt.includes(t.media_class)&&(()=>{const w=this.entity?.state==="off";this.hass.callService("media_player","play_media",{entity_id:this.entity.entity_id,media_content_id:t.media_content_id,media_content_type:t.media_content_type});if(w){const sv=localStorage.getItem(`ytmusic_volume_${this.entity.entity_id}`);setTimeout(()=>{this.hass.callService("media_player","volume_set",{entity_id:this.entity.entity_id,volume_level:sv!=null?parseFloat(sv):0.3})},2e3)}})() ):this.hass.callService("ytube_music_player","call_method",{entity_id:this.entity.entity_id,command:"goto_track",parameters:t.media_content_id})}static get styles(){return[o`
                :host {
                    display: grid;
 ...
 */(function*(t,e){if(void 0!==t){let i=0;for(const s of t)yield e(s,i++)}}(t,t=>V`<span class="crumb">${t}</span>`),V`<span class="separator">/</span>`)}
        ...
        `}_renderPlay(){const t=this._browseHistory[this._browseHistory.length-1];if(null==t?void 0:t.can_play)return V`
                <div class="playable_result">
                    ...
                    <button
                        class="play-btn"
                        @click=${()=>{const w=this.entity?.state==="off";this.hass.callService("media_player","play_media",{entity_id:this.entity.entity_id,media_content_id:t.media_content_id,media_content_type:t.media_content_type});if(w){const sv=localStorage.getItem(`ytmusic_volume_${this.entity.entity_id}`);setTimeout(()=>{this.hass.callService("media_player","volume_set",{entity_id:this.entity.entity_id,volume_level:sv!=null?parseFloat(sv):0.3})},2e3)}}
                    >
                        Play
                    </button>
                </div>
